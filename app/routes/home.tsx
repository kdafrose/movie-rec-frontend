        ...
        <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-8 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
            ...
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              <h2 className="text-3xl font-semibold tracking-tight text-balance text-white sm:text-4xl">Don't know what to watch? Try using our recommendation engine!</h2>
              <p className="mt-6 text-lg/8 text-pretty text-gray-300">Get personalized movie recommendations based on your preferred genres and viewing history.</p>
