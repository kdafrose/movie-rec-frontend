            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="md:flex md:items-center md:gap-6">
                    ...
                    <ul className="flex items-center gap-6 text-sm">
                        <li>
                        <a className="text-gray-500 transition hover:text-gray-500/75" href="/signup"> Create Account </a>
                        </li>
                        <li>
                        <a className="text-gray-500 transition hover:text-gray-500/75" href="/signin"> Sign In </a>
                        </li>
                        <li>
